...
Shader "JS Games/Nature/Hey Leaf Illum Shake" 
{
    Properties
    {
    ...
    SubShader
    {
        ...
        void surf(Input IN, inout SurfaceOutput o) {
            ...
            if (_BrightnessV > 1) o.Emission = c.rgb * UNITY_LIGHTMODEL_AMBIENT.xyz * _BrightnessV; // Multiply by ambient light
            else o.Emission *= tex2D(_Illum, IN.uv_Illum).a; // Multiply by illumination map
